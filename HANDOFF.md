...
- **Next Up:** two defensible choices. **Phase 14 (M45–47)** — Payment/Receipt vouchers, Cash Book, and the P&L / Balance Sheet, which are finally meaningful now that purchases exist to cost against revenue. Or **M32 (RBAC)**, which unlocks M33, M34, M49 and the maker-checker approval left open in M48; today every screen is reachable by anyone and the login role is cosmetic.
