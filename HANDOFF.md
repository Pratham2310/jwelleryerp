...
- **Next Up:** **Milestone 28 — Accounting Ledgers & Auto-Journal Posting**, opening Phase 9. **Land the money-as-float fix first**: every figure in the app is a JS number today, and double-entry postings that must balance to the paisa are exactly where that starts to bite.
