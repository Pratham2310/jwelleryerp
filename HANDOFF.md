...
- **Next Up:** **Milestone 28 — Accounting Ledgers & Auto-Journal Posting**, opening Phase 9. Its prerequisite is now in place: use `allocate()` for anything that must split and still balance.
