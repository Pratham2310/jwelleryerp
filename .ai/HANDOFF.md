...
- **Next Up:** **Milestone 29 — Tally Prime export.** A downloaded XML file only, per the simulation ground rule in `.ai/IMPLEMENTATION_WORKFLOW.md` — no real Tally integration.
