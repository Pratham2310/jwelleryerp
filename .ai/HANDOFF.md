...
- **Next Up:** **M49 (User Management)**. M32 defines roles and M33 records who approved a transaction, but there is still no way to create or deactivate the operators those roles are assigned to — and M33's supervisor roster currently keeps its own list of people for exactly that reason, which is the seam M49 should close. After that, M42–M44 (Stock Adjustment, Melting, Inventory Dashboard) and M50–M53.
